...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k25n7qm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k25n7qm.containers.anotherwebservice.com/
...
```
git clone git@github.com:caoh29/container-k25n7qm.git
cd container-k25n7qm
```
...
```
docker attach container-k25n7qm
```
